...
public val Icons.MainStoreIconNormal: ImageVector
    get() {
        if (_mainStoreIconNormal != null) {
            return _mainStoreIconNormal!!
        }
        _mainStoreIconNormal = Builder(name = "MainStoreIconNormal", defaultWidth = 28.0.dp,
...
private var _mainStoreIconNormal: ImageVector? = null

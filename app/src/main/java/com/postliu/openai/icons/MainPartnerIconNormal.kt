...
public val Icons.MainPartnerIconNormal: ImageVector
    get() {
        if (_mainPartnerIconNormal != null) {
            return _mainPartnerIconNormal!!
        }
        _mainPartnerIconNormal = Builder(name = "MainPartnerIconNormal", defaultWidth = 28.0.dp,
...
private var _mainPartnerIconNormal: ImageVector? = null

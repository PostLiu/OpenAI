...
public val Icons.MainUserIconSelected: ImageVector
    get() {
        if (_mainUserIconSelected != null) {
            return _mainUserIconSelected!!
        }
        _mainUserIconSelected = Builder(name = "MainUserIconSelected", defaultWidth = 28.0.dp,
            ...
            path(fill = SolidColor(Color(0xFFee463b)), stroke = SolidColor(Color(0x00000000)),
                    strokeLineWidth = 1.3f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(10.307f, 16.256f)
                horizontalLineToRelative(7.386f)
                arcToRelative(5.0f, 5.0f, 0.0f, false, true, 5.0f, 5.0f)
                verticalLineToRelative(0.159f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, -2.0f, 2.0f)
                lineTo(7.307f, 23.415f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, -2.0f, -2.0f)
                lineTo(5.307f, 21.256f)
                arcTo(5.0f, 5.0f, 0.0f, false, true, 10.307f, 16.256f)
                close()
            }
...
private var _mainUserIconSelected: ImageVector? = null

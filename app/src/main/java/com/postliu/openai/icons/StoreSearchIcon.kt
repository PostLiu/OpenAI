...
public val Icons.StoreSearchIcon: ImageVector
    get() {
        if (_storeSearchIcon != null) {
            return _storeSearchIcon!!
        }
        _storeSearchIcon = Builder(name = "StoreSearchIcon", defaultWidth = 18.0.dp, defaultHeight =
...
private var _storeSearchIcon: ImageVector? = null
